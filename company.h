...
class company_t
{
	...
	public:                         
		 ...
		 */
		void
		handle_ec(int postal_code) const;
		/**
		 ...
		 */
		void
		handle_ecge(int postal_code) const;
		/**
		 ...
		 */
		void
		handle_ecgt(int postal_code) const;
		/**
		 ...
		 */
		void
		handle_ecle(int postal_code) const;
		/**
		 ...
		 */
		void
		handle_eclt(int postal_code) const;
		/**
		 ...
		 */
		void
		envelopes_push_back(envelope_t envelope);
		/**
